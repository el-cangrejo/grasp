...
int main(int _argc, char **_argv)
{
	...
	const auto stats_filename = "data/stats/baseline_stats_cvae10_50.npy";
  ...
  const auto grasp_data = xt::load_npy<double>(grasp_file);
	...
	const auto trajectories_file = "data/traj/trajectories_cvae10_50.npy";
  const auto trajectories_data = xt::load_npy<double>(trajectories_file);

	/* const auto indices_file = "data/traj/indices_pca_10.npy"; */
	const auto indices_file = "data/traj/indices_cvae10_50.npy";
