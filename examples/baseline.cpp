...
int main(int _argc, char **_argv) {
  ...
  const std::string stats_filename =
      "data/stats/baseline_stats_" + encoder_name + "_10.npy";
  ...
  const std::string trajectories_file =
      "data/traj/trajectories_" + encoder_name + "_10.npy";
  /* const std::string trajectories_file =
   * "data/traj/unsuccessful_trajectories.npy"; */
  ...
  const std::string indices_file =
      "data/traj/indices_" + encoder_name + "_10.npy";
